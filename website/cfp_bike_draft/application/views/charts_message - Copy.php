            ...
            <div class="page-content">
                    ...
                    <div class="page-content-holder no-padding">
                        ...
                        <div class="page-title">                            
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">For the Bikers</a></li>
                                <li class="active">Safety 101</li>
                            </ul>               
                            <!-- ./breadcrumbs -->
                        </div>
                        <!-- ./page title -->
                ...
                <div class="page-content-wrap">                    
                    ...
                    <div class="block-heading block-heading-centralized this-animate" data-animate="fadeInDown">
                            <h2 class="heading-underline" style="padding-top: 10px; padding-bottom: 10px;">Safety 101</h2>
                        </div>
                            ...
                            <div class="container"><!-- start of tab contents container -->
                                ...
                                <div class="tab-content"> <!-- start of contents of tabs -->
                                        ...
                                        <div class="tab-pane" id="tab_b">
                                            <h4><br>It's the Law</h4>
                                            <p>
                                                <script type="text/javascript">
                                                function ShowHideDiv(NJLaw) {
                                                    var NJLaw-contents = document.getElementById("NJLaw-contents");
                                                    NJLaw-contents.style.display = NJLaw.checked ? "block" : "none";
                                                }
                                            ...
                                            <label for="NJLaw">
                                                <input type="checkbox" id="NJLaw" onclick="ShowHideDiv(this)" />
                                                NJ State Law
                                            </label>
                                            ...
                                            <hr />
                                            <div id="NJLaw-contents" style="display: none">
                                            <br>
                                                NJ State Law
                                                
                                            </div>
                                            <div id="dvPassport2" style="display: none; z-index: 0;">
                                                <br>
                                                <p>

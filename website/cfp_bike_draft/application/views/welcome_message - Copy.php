        ...
        <div class="page-container">
            ...
            <div class="page-header">
                ...
                <div class="page-header-holder">
                    ...
                    <!-- page logo -->
                    <div class="logo">
                        <a href="<?=  base_url(); ?>">Bike View NJ - Data, Visualizations, Safety for Everybody</a>
                    </div>
                    <!-- ./page logo -->
                    ...
                    <ul class="navigation">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="<?=  base_url()?>index.php/LoadView/overview">Project Overview</a></li>
                                <li><a href="<?=  base_url()?>index.php/LoadView/team">The Team</a></li>
                                <li><a href="<?=  base_url()?>index.php/LoadView/contact">Contact Us</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#">Visualizations</a>
                            <ul>
                                <li><a href="<?=  base_url()?>index.php/LoadView/streetmap"> Street Map - Bike Crashes</a></li>
                                <li><a href="<?=  base_url()?>index.php/LoadView/charts">Charts</a></li>                                
                            </ul>
                        </li>
                        <li>
                            <a href="<?=  base_url()?>index.php/LoadView/reportincident">Report an Incident</a>
                        </li>
                        <li><a href="https://play.google.com/store/apps/details?id=net.andromo.dev618807.app592325&hl=en" target="_blank">Get Mobile <strong> Safety </strong> app</a></li>
                    </ul>
                    <!-- ./navigation -->                        
                ...
                <div class="page-content-wrap bg-img-2 light-elements">
                    ...
                    <div class="page-content-holder">
                        ...
                        <div class="block-heading block-heading-centralized this-animate" data-animate="fadeInDown">
                            <h2><strong>Bike View</strong> &mdash; Data, Visualizations and Safety for Everybody</h2>
                ...
                <div class="page-footer-wrap bg-dark-gray">
                    ...
                    <div class="page-footer-holder page-footer-holder-main">
                        ...
                        <div class="row">
                            ...
                            <!-- about -->
                            <div class="col-md-3">
                              <p class="text-center"> <img src="img/cfp_logo.png" /></p>

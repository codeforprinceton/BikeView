            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap bg-light">
                    ...
                    <div class="page-content-holder no-padding">
                        ...
                        <div class="page-title">                            
                            <h1>Street Maps - Bicycle Crashes</h1>
                            <!-- breadcrumbs -->
                            <ul class="breadcrumb">
                                <li><a href="index.html">Home</a></li>
                                <li><a href="#">For Data Analysts</a></li>
                                <li class="active">Street Map - Bicycle Crashes</li>
                            </ul>               
                            <!-- ./breadcrumbs -->
                        </div>
                        <!-- ./page title -->
                ...
                <div class="page-content-wrap">                    
                    ...
                    <div class="block-heading block-heading-centralized this-animate" data-animate="fadeInDown">
                            <h2 class="heading-underline" style="padding-top: 10px;">NJ Bicycle Crashes Visualized</h2>
                        </div>

                        <div class="row" style="font-size: 14px;">
                            <p>These street-level maps show the exact locations of accidents in the Princeton/West-Windsor area between 2001 and 2014. Each accident is represented with a dot. If there were multiple accidents at a specific location, the dots are aggregated and the count shown within a larger circle. When looking at this street-level detail, it's clear that intersections along major roads are the most frequent location for accidents
                                    <p>&nbsp;</p>
                                    <p><iframe width="100%" height="700px" src="http://arcg.is/2n1krjm"></iframe></p>
                        </div>

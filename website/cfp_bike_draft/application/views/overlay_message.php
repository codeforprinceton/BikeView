            ...
            <div class="page-content">
                    ...
                    <div class="page-content-holder no-padding">
                        ...
                        <div class="page-title">                            
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Map Overlays</li>
                            </ul>               
                            <!-- ./breadcrumbs -->
                        </div>
                        <!-- ./page title -->
                ...
                <div class="page-content-wrap">                    
                    ...
                    <div class="block-heading block-heading-centralized this-animate" data-animate="fadeInDown">
                            <h2 class="heading-underline" style="padding-top: 10px; padding-bottom: 10px;">Map Overlays</h2>
                        </div>
                        ...
                        <div class="row" style="font-size: 14px;">
                            ...
                            <script type="text/javascript">
                                            ...
                                            <div id="chkPassport" style="font-size: 17px; font-color: #aaa;">
                                            <label for="chkPassport">
                                                <input type="checkbox" id="chkPassport" onclick="ShowHideDiv(this)" />
                                                Show Overlay with Crash Data
                                            </label> </div>

                                           <!--<div id="chkPassport2" style="font-size: 17px;">
                                            ...
                                            <div id="dvPassport" style="display: none; font-size: 16px; font-weight: bold; position: relative; z-index: 0;">
                                            <br>
                                                <img src="<?= base_url();?>/assets/img/wcrash.png"  />

                                            </div>
                                            <div id="dvPassport2" style="font-size: 16px; font-weight: bold; position: relative; z-index: 0;">
                                                <br>
                                               

                                                <img src="<?= base_url();?>/assets/img/wocrash.png"/>
